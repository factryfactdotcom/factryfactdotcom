...
const SomeQuickFacts = () => {
  const stats = [
    {
      data: '40',
      title: 'Years of Cumulative IT Solutioning Experience',
      icon: (
        <svg
    ...
    {
      data: '5',
      title: 'Years of Machining Industry Experience',
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      data: '133453',
      title: 'ERP Transactions handled across various modules',
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
