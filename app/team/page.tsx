...
const page = () => {
  const team = [
    {
      avatar:
        'https://media.licdn.com/dms/image/C5103AQELWb_Jj2O6ww/profile-displayphoto-shrink_800_800/0/1548350425136?e=2147483647&v=beta&t=bJ57Cw7GUKUf60FfYoCaicvEsc3lpbJR7fdJZPzVwT8',
      name: 'Steve Jobs',
      title: 'Founder & CEO',
    ...
    {
      avatar: 'https://cdn.britannica.com/47/188747-050-1D34E743/Bill-Gates-2011.jpg',
      name: 'Bill Gates',
      title: 'Co-Founder & MD',
      desc: "Lorem Ipsum is simply dummy text of the printing and typesettin industry. Lorem Ipsum has been the industry's standard dummy",
      linkedin: '/',
    ...
    {
      avatar:
        'https://www.blackrock.com/blk-corp-assets/cache-1665652128000/images/media-bin/web/global/headshots/headshot-fink-larry-400x400.png',
      name: 'Lary Fink',
      title: 'Boss',
      desc: "Lorem Ipsum is simply dummy text of the printing and typesettin industry. Lorem Ipsum has been the industry's standard dummy",
      linkedin: '/',
    ...
    <section className="py-14">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-xl">
          <h3 className="text-gray-700 text-3xl font-semibold sm:text-4xl" style={{ fontFamily: 'Rajdhani' }}>
              ...
              <li key={idx} className="gap-8 sm:flex">
                ...
                <div className="mt-4 sm:mt-0">
                  ...
                  <div className="mt-3 flex gap-4 text-gray-400">
                    <a href={item.twitter}>
                      <svg className="w-5 h-5 duration-150 hover:text-teal-500" fill="currentColor" viewBox="0 0 48 48">
                    ...
                    <a href={item.linkedin}>
                      <svg className="w-5 h-5 duration-150 hover:text-teal-500" fill="none" viewBox="0 0 48 48">
                  ...
                  <button className="px-3 py-1.5 my-5 text-sm text-gray-700 duration-100 border rounded-lg hover:border-teal-600 active:shadow-lg">
                    Read More
                  </button>
                </div>
              </li>
